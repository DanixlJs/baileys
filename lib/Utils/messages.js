...
import { downloadContentFromMessage, encryptedStream, generateThumbnail, getAudioDuration, getAudioWaveform } from "./messages-media.js";
const MIMETYPE_MAP = {
    image: "image/jpeg",
    video: "video/mp4",
...
export const prepareWAMessageMedia = async (message, options) => {
    ...
    const { mediaKey, encWriteStream, bodyPath, fileEncSha256, fileSha256, fileLength, didSaveToTmpPath } = await encryptedStream(uploadData.media, options.mediaTypeOverride || mediaType, {
        logger,
