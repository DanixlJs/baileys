import SenderChainKey from "./sender_chain_key.js";
import SenderMessageKey from "./sender_message_key.js";
import protobufjs from "./protobufs";
export default class SenderKeyState {
    ...
    constructor(id = null, iteration = null, chainKey = null, signatureKeyPair = null, signatureKeyPublic = null, signatureKeyPrivate = null, senderKeyStateStructure = null) {
        if (senderKeyStateStructure) {
            ...
            this.senderKeyStateStructure = protobufjs.create();
            const senderChainKeyStructure = protobufjs.create();
            ...
            const signingKeyStructure = protobufjs.create();
    ...
    setSenderChainKey(chainKey) {
        const senderChainKeyStructure = _SenderChainKey.create({
    ...
    addSenderMessageKey(senderMessageKey) {
        const senderMessageKeyStructure = SenderKeyStateStructure.create({
